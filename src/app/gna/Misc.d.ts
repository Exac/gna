...
/* tslint:disable:no-empty-interface member-ordering max-line-length comment-format semicolon unified-signatures class-name */
...
/* tslint:enable:no-empty-interface member-ordering max-line-length comment-format semicolon unified-signatures class-name */
